...
#ifdef MOD_NTKS
	ADD_DEF_TASK( TASK_GET_PATH_AWAY_FROM_BULLET_IMPACT );
#endif
...
#ifdef MOD_NTKS
	ADD_DEF_TASK( TASK_STORE_BULLET_IMPACT_IN_SAVEPOSITION );
#endif
...
#ifdef MOD_NTKS
	ADD_DEF_TASK( TASK_FIND_COVER_FROM_BULLET_IMPACT );
#endif
